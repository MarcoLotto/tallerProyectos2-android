 ...
 */
public class SendCommentHttpAsyncTask extends HttpAsyncTask {
    ...
    public SendCommentHttpAsyncTask(Activity callingActivity, CallbackScreen callbackScreen, int serviceId,
    ...
    protected void configureRequestFields() {
        ...
        try {
            ...
            jObject.put("postType", WallPostType.COMMENT.getType()); // Tipo de wallPost
